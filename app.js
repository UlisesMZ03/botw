...
const conversacionPrincipal = addKeyword(['hola', 'ole', 'buenas', 'inicio','buenos','dias','saludos','hello','hi','Como estas?','pura vida','todo bien'])
  ...
  .addAnswer(
      [`Estas son las opciones:`,'👉Selecciona *Cita* para obtener el link','👉 Selecciona *Precio* para obtener los precios','👉 Selecciona *Horario* para obtener los horarios','👉 Selecciona *Ubicacion* para obtener la ubicacion,','👉 Selecciona *Fotos* para obtener fots de algunos cortes.'],buttons:[
          {
            body: 'Cita'
          },
          {
